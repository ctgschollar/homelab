...
class SafetyPolicy:
    def __init__(self, config: dict) -> None:
        ...
        self.global_safe_mode: bool = safety.get("global_safe_mode", True)

        safe_resources = safety.get("safe_mode_resources", {})
        self._safe_stacks: list[str] = safe_resources.get("stacks", [])
        self._safe_services: list[str] = safe_resources.get("services", [])
        self._safe_nodes: list[str] = safe_resources.get("nodes", [])

        self.tool_tiers: dict[str, int | str] = safety.get("tool_tiers", {})
        self.log_agent_tier_reasoning: bool = safety.get("log_agent_tier_reasoning", True)
